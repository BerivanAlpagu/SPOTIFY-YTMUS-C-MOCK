...
// ─────────────────────────────────────────────────────────────────────────────
// LyraApp Ham Renk Tokenleri
// Kaynak: docs/design/00-color-system.md
//
// KURAL: Ham Color(..) tanımı YALNIZCA bu dosyada yapılır.
//        Composable'larda doğrudan Color(0xFF…) yazılmaz;
//        renkler MaterialTheme.colorScheme.<slot> üzerinden okunur.
// ─────────────────────────────────────────────────────────────────────────────
